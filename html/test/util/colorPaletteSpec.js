describe("colorPalette", function() {
    ...
    describe("getColor", function() {
        it("shouldCreateAColorPalette", function() {
            var data = [{"val": 0}, {"val": 12}, {"val": 20}, {"val": 21}, {"val": 30}, {"val": 45},{"val": 32}, {"val": 1}, {"val": 80}];
            var fieldToBeCompared = function(ele) {return ele.val};
            var palette = JSSMaps.util.colorPalette().init(data, fieldToBeCompared);
        ...
        it("shouldMatchTheGradesthatItProvides", function() {
            ...
            grades.find = function(value) {return this.grades.filter(function(grade){return grade.min <= value && grade.max > value })[0]};
